...
import static dev.tomek.benchmarksocket.config.CommonConfig.TRANSPORT_SOCKET_REFINED;

@Log4j2
@Component
@ConditionalOnProperty(name = PARAM_TRANSPORT, havingValue = TRANSPORT_SOCKET_REFINED)
public class PitchSocketRefined extends PitchSocketAbstract {
    public static final int BUFFER_SIZE = 1000;
    private int sent;

    public PitchSocketRefined(
